...
class PneumaticSettings : public QObject
{
    ...
    public:
         ...
         * @param parent
         */
        PneumaticSettings(int id, const QString &unit, const QString &title, const QString &help,
...
public:
     ...
     * @param help
     */
    explicit DrivingPressure(int id, const QString &title = QStringLiteral("Driving Pressure"),
...
public:
     ...
     * @param help
     */
    explicit Rate(int id, const QString &title = QStringLiteral("Rate"),
...
public:
     ...
     * @param help
     */
    explicit InspiratoryTime(int id, const QString &title = QStringLiteral("Inspiratory Time"),
...
public:
     ...
     * @param help
     */
    explicit StackingPressure(int id, const QString &title = QStringLiteral("Stacking Pressure"),
...
public:
     ...
     * @param help
     */
    explicit PIP(int id, const QString &title = QStringLiteral("Peak Insp. Pressure"),
...
public:
     ...
     * @param help
     */
    explicit AuxFlow(int id, const QString &title = QStringLiteral("Auxiliary Flow"),
...
public:
     ...
     * @param help
     */
    explicit Humidity(int id, const QString &title = QStringLiteral("Humidity"),
...
public:
     ...
     * @param help
     */
    explicit ETCO2Rate(int id, const QString &title = QStringLiteral("ETCO<sub>2</sub> Rate"),
...
public:
     ...
     * @param help
     */
    explicit ETCO2IT(int id, const QString &title = QStringLiteral("ETCO<sub>2</sub> Inspiratory Time"),
                     const QString &help = QStringLiteral("End-tidal CO<sub>2</sub> (ETCO<sub>2</sub>) mode is used when users need to perform an ETCO<sub>2</sub> measurement using an external ETCO<sub>2</sub> monitor. When enabled, the system changes the respiratory rate, inspiratory time, and driving pressure to user-set values which are more representative of natural ventilation. This enables the ability to acquire a more accurate ETCO<sub>2</sub> measurement using an external capnograph."));
};
...
public:
     ...
     * @param help
     */
    explicit ETCO2Breaths(int id, const QString &title = QStringLiteral("ETCO<sub>2</sub> Number of Breaths"),
                          const QString &help = QStringLiteral("End-tidal CO<sub>2</sub> (ETCO<sub>2</sub>) mode is used when users need to perform an ETCO<sub>2</sub> measurement using an external ETCO<sub>2</sub> monitor. When enabled, the system changes the respiratory rate, inspiratory time, and driving pressure to user-set values which are more representative of natural ventilation. This enables the ability to acquire a more accurate ETCO<sub>2</sub> measurement using an external capnograph."));
};
...
public:
     ...
     * @param help
     */
    explicit ETCO2DP(int id, const QString &title = QStringLiteral("ETCO<sub>2</sub> Driving Pressure"),
                     const QString &help = QStringLiteral("End-tidal CO<sub>2</sub> (ETCO<sub>2</sub>) mode is used when users need to perform an ETCO<sub>2</sub> measurement using an external ETCO<sub>2</sub> monitor. When enabled, the system changes the respiratory rate, inspiratory time, and driving pressure to user-set values which are more representative of natural ventilation. This enables the ability to acquire a more accurate ETCO<sub>2</sub> measurement using an external capnograph."));
};
...
public:
     ...
     * @param help
     */
    explicit LaserO2(int id, const QString &title = QStringLiteral("Limted O<sub>2</sub>"),
...
public:
     ...
     * @param help
     */
    explicit Volume(int id, const QString &title = QStringLiteral("Volume"),
