...
toolchainCmakeDir=${OECORE_NATIVE_SYSROOT}/usr/share/cmake//OEToolchainConfig.cmake.d
mkdir -p ${toolchainCmakeDir}
cat scripts/imx6.cmake | envsubst > ${toolchainCmakeDir}/imx6.cmake
cp scripts/OEQt5Toolchain.cmake ${toolchainCmakeDir}
