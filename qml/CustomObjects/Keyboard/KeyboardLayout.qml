...
Rectangle {
    ...
    function createFirstRow(row)
    {
        ...
        var component = Qt.createComponent("KeyboardButton.qml");
    ...
    function createReturnKey(popupStack)
    {
        var x_coordinate = root_window.x + 248 + 500 + 52
        var y_coordinate = root_window.y + 300
        var component = Qt.createComponent("KeyboardButton.qml");
        if (component.status === Component.Ready)
        {
    ...
    function createCancelKey(popupStack, previous_name)
    {
        var x_coordinate = root_window.x;
        var y_coordinate = root_window.y + 300;
        var component = Qt.createComponent("KeyboardButton.qml");
