...
Rectangle {
    ...
    {
        backend.sensorCalibration(1,4,0)
    ...
    SlidingBox
    {
        ...
        Rectangle
        {
            ...
            VerifyButton
            {
                ...
                enabled: lowVerifyState && state_manager.inletO2 <= 30
            ...
            Rectangle
            {
                ...
                Text {
                    id: lastVerifyValue
                    text: zero_manager.verifiedInletO2
                    color: Style.primary_light
                    font: Style.settingPageTitle
                    anchors.centerIn: parent
                }
            ...
            VerifyButton
            {
                ...
                enabled: highVerifyState && state_manager.inletO2 >= 31

                onClicked:
                {
                    zero_manager.addVerifiedValue(4, state_manager.inletO2)
        ...
        Rectangle
        {
            ...
            onClicked:
            {
                backend.sensorCalibration(0,4,0);
                popupStack.clear()
            }
    ...
    property string o2Text: "If the Inlet Air Sensor is reading measurements while Air is not connected, the service technician will be required to conduct a " +
                            ...
                            "NOTE: Remove the Oxygen gas supply line from the rear of the NVENT VITA and ensure no pressure is in the system.<br><br>" +
                            "To verify the Inlet O<sub>2</sub> Measurement is accurate, the following steps need to be conducted:<br><br>" +
                            "1. Apply 30 PSI or below to the Oxygen gas supply line on the rear panel of the NVENT VITA. <br>" +
                            ...
                            "4. Apply 31 PSI or above to the Oxygen gas supply line on the rear panel of the NVENT VITA. <br>" +
